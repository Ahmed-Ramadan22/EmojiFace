...
public class Emojifier {
    ...
    static Bitmap detectFaces(Context context , Bitmap picture){
        ...
        // Build the frame : Given a bitmap, we can create Frame instance from the bitmap to supply to the detector:
        Frame frame = new Frame.Builder().setBitmap(picture).build();

        // Detect the faces : The detector can be called synchronously with a frame to detect faces:
        ...
        /*
          If there are no faces detected, show a Toast message
            The result returned includes a collection of Face instances
         */
         ...
         *   The face detector uses native resources in order to do detection.
         *     For this reason, it is necessary to release the detector instance once it is no longer needed:
         */
        detector.release();
